...
os.path.join((data_dir, 'infected_cm_b_0.2.txt'), delimiter=',')  # Vector con la proporción de infectados
...
t = np.linspace(0, tmax, int(tmax / dt))    # vector de tiempos
print(len(P_0_1), len(t))
#print(infected_cm)
...
plt.ylabel('Probabilidad de infeccción')
...
b = 0.3 # tasa de contagio
tmax = 160  # tiempo máximo de cálculo de las proporciones SIR
